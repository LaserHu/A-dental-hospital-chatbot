...
class Availabledoctor(Resource):
    ...
    def get(self):
        print(g.args['Date'])
        try:
            dbconnection = connectcloud('ds161517.mlab.com',61517,'chatbot','huchangshuo','z5187447','DentalClinicTimetable')
            dbconnection1 = connectcloud('ds161517.mlab.com',61517,'chatbot','huchangshuo','z5187447','DentalClinicDoctor')
